...
namespace IdentityService.Migrations
{
    ...
    [Migration("20250722035020_AddMfaTokenToSmsVerificationCode")]
    partial class AddMfaTokenToSmsVerificationCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityService.Domain.Entities.SmsVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MfaToken")
                        .IsUnique()
                        .HasFilter("[MfaToken] IS NOT NULL");
            ...
            modelBuilder.Entity("IdentityService.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasOne("IdentityService.Domain.Entities.ApplicationRole", "Role")
                        .WithMany("RolePermissions")
